...
test.describe('TC_001', () => {
    ...
    test.only("TC_001", async ({ page, context, browser, loginPage, dashboardPage, timeTrackerPage, reportPage, adminPage }) => {
...
test.describe('TC_013', () => {
    ...
    //Validate the downloaded results
